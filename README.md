...
Shipped app: **2.71** (`com.abysscore.exgc`, versionCode 79). One framework, two skins:
...
- **Cube viz** — one 2×2×2 cube is 8 bits. Tap a bit to pick its algo, long-press for channel. **Algos** tab holds the CubalC defaults (sign, energy, compare…) plus ones you add. **float on/off**, drag to spin, +/− or pinch to zoom. Sites live in Settings.
