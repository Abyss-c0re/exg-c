...
Shipped app: **2.83** (`com.abysscore.exgc`, versionCode 91). One framework, two skins:
...
- **NEG RAIL** turns bias off on every channel and picks one 10-10 site for the shared negative electrode (A1/A2/M1/M2 or a scalp site).
