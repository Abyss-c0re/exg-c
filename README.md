...
Shipped app: **2.48** (`com.abysscore.exgc`, versionCode 57). One framework, two skins:
...
- **This board or follow leftover.** Board is Knight USB. Follow leftover pairs over Bluetooth; after **Allow**, leftover rides that link. Wifi address is shared if wifi is up. Revoke who can follow; forget who you follow.
